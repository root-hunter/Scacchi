...
public class Scacchiera{
    protected ArrayList<ArrayList<Casella>> scacchiera = new ArrayList<ArrayList<Casella>>();

    protected ArrayList<Casella> casePromozioneBianco = new ArrayList<>();
    protected ArrayList<Casella> casePromozioneNero = new ArrayList<>();
 
    protected Pezzo reBianco;
    protected ArrayList<Pezzo> pezziBianchi = new ArrayList<>();

    protected Pezzo reNero;
    protected ArrayList<Pezzo> pezziNeri = new ArrayList<>();
    ...
    public Scacchiera(Scacchiera that){
        initCaselle();
    ...
    private void initCaselle() {
        for(int i = 0; i < MAX; ++i){
            ...
            for(int j = 0; j < MAX; ++j){
                Casella casella = new Casella(j + 1, i + 1, null);
                if(i == 0){
                    casePromozioneNero.add(casella);
                }else if(i == MAX - 1){
                    casePromozioneBianco.add(casella);
                }
